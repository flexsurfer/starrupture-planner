...
import {
  normalizePlannerActiveTabId,
  normalizePlannerTabs,
} from "./planner-tabs-storage";
...
export const PERSIST_KEYS = [
  {
    key: stateKeys.basesMode,
    deserialize: (value: unknown) =>
      value === "planning" || value === "advanced" ? value : null,
  },
  {
    key: stateKeys.basesDetailsExpanded,
    deserialize: (value: unknown) =>
      typeof value === "boolean" ? value : true,
  },
  { key: stateKeys.plannerTabs, deserialize: normalizePlannerTabs },
  {
    key: stateKeys.plannerActiveTabId,
    deserialize: normalizePlannerActiveTabId,
  },
  "uiTheme",
  "appDataVersion",
  {
