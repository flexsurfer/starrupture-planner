...
export const PlannerViews = ({
  ...
  const setActiveView = (view: (typeof VIEWS)[number]) =>
    runtime.dispatch([appIds.events.PLANNER_SET_ACTIVE_VIEW, view]);
  const id = useId();
  ...
  const viewControl = (
    <div
      ...
      className="join inline-flex w-fit shrink-0 rounded-md border border-base-300 bg-base-100"
    >
    ...
    <div className="h-full min-h-0 flex flex-col">
      ...
      <div className="relative isolate flex-1 min-h-0">
        ...
        {VIEWS.map((view) => (
          ...
          >
            {calculationPaused ? (
              <div className="flex h-full items-center justify-center p-4 text-base-content/70">
