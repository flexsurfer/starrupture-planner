          ...
          <div className="flex flex-col gap-2 p-2 sm:p-1 bg-base-200 shadow-lg shrink-0">
            <div className="flex flex-wrap items-center gap-x-1.5 gap-y-2 sm:gap-x-4 lg:gap-x-6">
              <div
                className={
                  mode === "single"
                    ? "flex w-full min-w-0 items-center gap-1.5 sm:contents"
                    : "contents"
                }
              >
                {mode === "multi" ? (
                  ...
                  <div className="flex min-w-0 flex-1 sm:flex-none items-center gap-2 sm:gap-4">
...
const PlannerPage: React.FC = () => {
  ...
  return (
    <div className="flex h-full min-h-0 min-w-0 flex-col bg-base-100">
      {activeTab ? (
        <>
          <PlannerTabs />
          <div
            id="planner-tab-panel"
            role="tabpanel"
            aria-labelledby={`planner-tab-${activeTab.id}`}
