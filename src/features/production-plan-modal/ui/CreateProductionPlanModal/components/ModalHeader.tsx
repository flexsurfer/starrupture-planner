...
export const ModalHeader: React.FC = () => {
  ...
  const { isEditMode } = useSubscription([
  ...
  const returnLabel =
    selectedTab === "plans"
      ? "Plans"
      : selectedTab === "buildings" && advanced
        ? "Buildings"
        : "Production";

  return (
    <NavigationHeader
      title={isEditMode ? "Edit Plan" : "New Plan"}
      breadcrumbs={[
        {
          label: "My Bases",
          onClick: () => {
