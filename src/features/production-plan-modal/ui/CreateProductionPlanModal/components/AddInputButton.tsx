...
export const AddInputButton: React.FC = () => {
  ...
  const handleAddInputBuildings = useCallback(
  ...
  return (
    <>
      <button
        ...
        title={
          planning && !valid
            ? "Choose a production item and enter a plan name first"
            : undefined
        }
      >
        <span aria-hidden="true">+</span>
        {planning ? "Add external item" : "Add input"}
      </button>
