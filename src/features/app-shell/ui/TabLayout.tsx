...
} from "@/features/data-transfer/ui/GlobalSettings";
...
const TabLayout = () => {
  ...
  useLayoutEffect(() => {
    ...
    const updateLayout = () => {
      ...
      const requiredWidth =
        [brand, navigation, controls].reduce(
    ...
    [header, brand, navigation, controls].forEach((element) =>
    ...
    <div className="h-screen flex flex-col bg-base-100">
      ...
      <div className="relative flex-shrink-0 bg-base-200 shadow-lg">
        ...
        >
          ...
          <div
            ref={desktopBrandRef}
            className="flex w-max items-center gap-3 col-start-1 row-start-1"
          >
            <img
          ...
          <div className="flex justify-center col-start-2 row-start-1">
            <div
              ref={desktopTabsRef}
              className="tabs tabs-bordered tabs-lg w-max flex-nowrap justify-center"
            >
              {tabs.map((tab) => (
                <button
                  key={tab.id}
          ...
          <div
            ref={controlsRef}
            className="ml-auto flex w-max shrink-0 items-center justify-end gap-2 row-start-1 col-start-3"
          >
            <GlobalSettingsButton
              onClick={() => {
                runtime.dispatch([
        ...
        {/* Compact Layout */}
        <div
          className={`${tabsFitHeader ? "hidden" : "flex"} items-center gap-2 px-2 py-0.5`}
        >
      ...
      <div
        className={`${tabsFitHeader ? "hidden" : ""} bg-base-200 border-t border-base-300`}
      >
