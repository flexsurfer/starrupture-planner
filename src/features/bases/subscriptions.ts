...
export const registerBasesSubscriptions: UkladModule<
  ...
  registrar.regSub(
    ...
    ([collapsedSectionsByBaseId], baseId) =>
      resolveBaseCardCollapsedSections(
        collapsedSectionsByBaseId[baseId] as
          BaseCardCollapsedSections | undefined,
      ),
  );
