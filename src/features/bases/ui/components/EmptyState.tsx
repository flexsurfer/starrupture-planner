      ...
      <div className="max-w-md">
        ...
        {advanced && (
          <p className="text-base-content/70 mb-6">
            A Core is required to create a Base. The Core defines the buildable
            area where you can place buildings.
          </p>
        )}
        <p className="text-base-content/60 mb-8 text-sm">
          You can create and manage multiple Bases to organize your production
          facilities.
        </p>
        <button
          type="button"
