...
export const EnergyGridNode: React.FC<NodeProps> = memo(({ data }) => {
  ...
  return (
    <div
      className={`rounded-xl border-2 shadow-lg w-[200px] overflow-hidden ${
        isDeficit
