...
import type { PlannerRecipeOptionsItem } from '../../../../planner/core/types';
...
export const RecipeAlternativesSelector: React.FC = () => {
    const options = useSubscription<PlannerRecipeOptionsItem[]>([SUB_IDS.PRODUCTION_PLAN_MODAL_RECIPE_OPTIONS]) ?? EMPTY_RECIPE_OPTIONS;
    ...
    return (
        <div ref={rootRef} className="relative">
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 z-30 w-[min(92vw,560px)] max-h-[60vh] overflow-y-auto rounded-md border border-base-300 bg-base-100 p-2 shadow-xl">
