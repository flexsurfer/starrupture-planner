      ...
      <div className="flex items-start gap-2 sm:gap-3">
        ...
        <div className="flex gap-3 sm:gap-4 flex-wrap">
          ...
          <div>
            ...
            <div className={`text-base font-bold ${isHeatOverCapacity ? 'text-error' : ''}`}>{totalHeat} / {baseCoreHeatCapacity}</div>
          ...
          <div>
            ...
            <div className={`text-base font-bold ${isEnergyInsufficient ? 'text-error' : ''}`}>{energyConsumption} / {energyGeneration} MW</div>
            <div className="w-full bg-base-300 rounded-full h-1 mt-0.5">
              <div
