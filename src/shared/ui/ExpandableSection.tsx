...
/** Compact, keyboard-accessible section shared by the reference pages. */
export const ExpandableSection = ({ title, icon, summary, expanded, onToggle, children }: ExpandableSectionProps) => {
  const contentId = useId();

  return (
    <section className="min-w-0 rounded-lg border border-base-300 bg-base-100">
      <h2 className="sticky top-0 z-10 rounded-t-lg bg-base-200">
        <button
          type="button"
