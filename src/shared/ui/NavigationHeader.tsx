  ...
  <header className="mb-1 shrink-0 border-b border-base-300 px-1">
    ...
    <div className="flex min-h-8 min-w-0 items-center gap-1">
      ...
      <nav
        ...
        className={summary ? "shrink-0" : "min-w-0 flex-1 overflow-x-auto"}
      >
            ...
            <li key={index} className="flex items-center gap-1">
              ...
              {crumb.onClick ? (
                <button
                  ...
                  className="min-h-8 rounded px-1 hover:bg-base-content/5 hover:text-base-content focus-visible:outline-2 focus-visible:outline-primary"
                  title={crumb.label}
                >
                  {crumb.label}
                </button>
                ...
                <span
                  aria-current="page"
                  className="px-1 font-medium text-base-content"
                  title={crumb.label}
                >
                  {crumb.label}
                </span>
      ...
      {summary && (
        <div className="min-w-0 flex-1 overflow-x-auto">
          <div className="flex w-max items-center gap-2 px-2">{summary}</div>
        </div>
      )}
      {actions && (
        <div className="ml-1 flex shrink-0 items-center gap-2">{actions}</div>
      )}
    </div>
