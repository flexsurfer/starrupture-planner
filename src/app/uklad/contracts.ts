...
export interface AppContracts extends UkladContracts {
    state: {
        ...
        [stateKeys.plannerMultiRecipeSelections]: AppState['plannerMultiRecipeSelections'];
        [stateKeys.plannerGroupByStage]: boolean;
        [stateKeys.plannerFlowDirection]: AppState['plannerFlowDirection'];
        [stateKeys.plannerMode]: AppState['plannerMode'];
        [stateKeys.plannerMultiTargets]: AppState['plannerMultiTargets'];
    ...
    events: {
        ...
        [appIds.events.PLANNER_SET_FLOW_DIRECTION]: [direction: AppState['plannerFlowDirection']];
        [appIds.events.PLANNER_SET_MODE]: [mode: 'single' | 'multi'];
    ...
    subscriptions: {
        ...
        [appIds.subscriptions.PLANNER_FLOW_DIRECTION]: { params: []; result: AppState['plannerFlowDirection'] };
        [appIds.subscriptions.PLANNER_MODE]: { params: []; result: AppState['plannerMode'] };
        [appIds.subscriptions.PLANNER_MULTI_TARGETS]: { params: []; result: AppState['plannerMultiTargets'] };
